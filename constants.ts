    ...
    items: [
      {
        ...
        name: "Pure Açaí Bowl",
        ingredients:
          "Açaí berry, peanut butter, mango, kiwi, dragon fruit, banana, strawberries, blueberries, passion fruit.",
        price: "48",
      ...
      },
      {
        ...
        name: "Overnight Oats",
        ingredients:
          "Oats are soaked in oat milk with mixed-berry compote, peanut butter, and cashews.",
        price: "42",
        image: "https://iili.io/fvyqMn1.jpg",
        calories: 380,
      },
      {
        ...
        name: "Chia Bowl",
        ingredients:
          "Coconut chia pudding, Greek yogurt, strawberries, blackberries, raspberries, blueberries, mixed-berry compote, sesame toil, whipped chocolate, and shaved dark chocolate with an organic honey drizzle.",
        price: "38",
      ...
      },
      {
        ...
        ingredients:
          "Earl Grey Chia, fresh banana, sweet dates, creamy yogurt.",
        price: "38",
      ...
      },
      {
        ...
        ingredients:
          "Premium Matcha infused chia pudding, coconut milk, seasonal toppings.",
        price: "38",
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        name: "Black Forest",
        ingredients:
          "A decadent pastry filled with tart dark cherry compote and a light, whipped white chocolate ganache, finished with chocolate shavings.",
        price: "28",
      ...
      },
      {
        ...
        name: "Cardamom Bun",
        ingredients:
          "Cruffin-shaped croissant dough knotted with aromatic cardamom spice, baked to a golden crisp, and tossed in vanilla sugar for a buttery, spiced finish.",
        price: "22",
...
const applyGoldenRuleLayout = (menu: MenuCategory[]): MenuCategory[] => {
  ...
  const healthyBowls = extractAll((c) =>
    ["healthy-bowls", "fruits-grains", "fruits-gangs"].includes(c.id),
  );
  ...
  // 5.6 Salads & Greens
  const salads = extractAll((c) =>
    ["salads", "greens", "green-salad"].includes(c.id),
  );
  if (salads.length > 0) {
