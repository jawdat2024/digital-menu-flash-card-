import { MenuCategory, Branch, BranchMenuDirectory, MenuItem } from "./types";
...
export const BRANCH_DATA: Branch[] = [
  ...
  },
  {
    ...
    theme: "warm",
    description:
      "A sanctuary of specialty coffee with warm tones and minimalist vibes.",
  ...
  },
  {
    ...
    name: "CARTEL Marina",
    address:
      "38 Mohammed Bin Mejren Al Marar St, Al Kasir, Al Marina, Abu Dhabi",
  ...
  },
{
    ...
    items: [
      {
        ...
        name: "Exotic Sunrise",
        ingredients:
          "Coconut yogurt, homemade granola, passion fruit, mango slices, exotic gel, and lime zest.",
        price: "42",
        image: "https://iili.io/qtt1Pz7.jpg",
        calories: 360,
      },
      {
        ...
        ingredients:
          "Cinnamon yogurt, granola, apple crumble, soft caramel, berry compote, honeycomb, raspberries, blueberries, blackberries, apple crisp, mixed nuts, and organic honey drizzle.",
        price: "42",
        image: "https://iili.io/qttz2I4.jpg",
        calories: 410,
      },
      {
        ...
        name: "Overnight Oats",
        ingredients:
          "Oats are soaked in oat milk with mixed berry compote, peanut butter, and cashew nuts.",
        price: "42",
        image: "https://iili.io/fvyqMn1.jpg",
        calories: 380,
      },
      {
        ...
        ingredients:
          "White slice bread with pesto oil, fresh mozzarella, tomato slice, tartufo salami, chorizo, baby Rocca, sun-dried tomatoes, balsamic glaze, organic olive oil",
        price: "38",
  ...
  },
  {
    ...
    items: [

      {
        ...
        ingredients:
          "Basque-style burnt cheesecake, creamy center, caramelized exterior",
        price: "39.20",
      ...
      },
      {
        ...
        name: "Aseeda",
        ingredients:
          "Modern twist on traditional Aseeda, saffron, cardamom, date molasses, roasted nuts",
        price: "43",
      ...
      },
      {
        ...
        ingredients:
          "Silky smooth vanilla custard, Madagascar vanilla bean, sweet cream",
        price: "39.20",
      ...
      },
      {
        ...
        name: "Banana Pudding",
        ingredients:
          "Layers of vanilla wafers, fresh bananas, creamy vanilla pudding, whipped cream",
        price: "38",
      ...
      },
      {
        ...
        ingredients:
          "Crispy layers of puff pastry with caramels sauce and  vanilla cream",
        price: "39.20",
      ...
      },
      {
        ...
        name: "Sicky Date ",
        ingredients:
          "Warm, treacle-infused date cake, house-made candied pecans, and London Dairy Vanilla Ice Cream. Rich, velvety, and classic",
        price: "39.20",
  ...
  },
  {
    ...
    title: "Espresso",
    description:
      "Our espresso selection features distinct profiles:\n\n• BLIND 469\n• Amazonic Soul\n• Yemen - Sharki Haraz",
    items: [
      {
        id: "esp1",
        name: "Espresso",
    ...
    items: [
      {
        ...
        ingredients:
          "Flaky croissant dough muffin filled with tangy fresh labneh, topped with aromatic organic zaatar, olive oil, and a pinch of sea salt.",
        price: "22",
      ...
      },
      {
        ...
        name: "Burrata Pizza",
        ingredients:
          "Crisp round croissant base layered with rich tomato sauce, creamy fresh burrata, and basil, finished with chili flakes, smoked salt, and organic olive oil.",
        price: "26",
      ...
      },
      {
        ...
        ingredients:
          "Buttery Danish croissant dough wrapped around savory smoked turkey and sharp cheddar, encrusted with mixed sesame seeds.",
        price: "20",
      ...
      },
      {
        ...
        name: "Potato Truffle",
        ingredients:
          "Savory round croissant filled with caramelized onions and creamy potato dauphinois, topped with melted Comté cheese, truffle oil, smoked salt, and fresh chives.",
        price: "26",
      ...
      },
      {
        ...
        ingredients:
          "Golden croissant filled with rich almond frangipane, topped with toasted almond flakes and a dusting of icing sugar.",
        price: "22",
      ...
      },
      {
        ...
        ingredients:
          "Classic buttery croissant filled with premium Valrhona chocolate batons.",
        price: "17",
    ...
    },
    {
      ...
      items: [
        ...
        },
        {
          ...
          ingredients:
            "English muffins with cream cheese, tomato sauce, smoky bacon, poached eggs, and miso hollandaise.",
          calories: 450,
        },
        {
          id: "egg_truffle",
        ...
        },
        {
          ...
          ingredients:
            "mint labneh, homemade tomato jam, poached eggs, mint pesto, chilli butter served with 2 slices of toasted zaatar sourdough.",
          calories: 400,
        },
      ].filter(Boolean),
    },
      ...
      items: [
        {
          ...
          ingredients:
            "little gem lettuce, creaser dressing, crouton, parmesan cheese, crushed pistachio (add Ons: poached egg, bacon or chicken).",
          calories: 350,
        },
      ].filter(Boolean),
    },
      ...
      items: [
        {
          ...
          ingredients:
            "Toasted Brown slice bread with pesto oil, avocado, tuna mix, tomato, and jalapeños.",
          calories: 480,
        },
        {
          id: "sw_chick",
      ...
      items: [
        {
          ...
          image: "https://iili.io/q2ARzyG.jpg",
          ingredients:
            "Caramelized and served with vanilla ice cream, almond streusel, whipped vanilla cream, and rhubarb compote (option: salted caramel, mix berries compote)",
        },
      ],
    },
    {
    ...
    },
    {
      ...
      items: [
        ...
        },
        {
          ...
          image: "https://iili.io/qqG2qR1.png",
          ingredients:
            "A buttery, toasted kalonji-seed square croissant filled with tender grilled chicken and fresh avocado slices. Layered with crisp Lollo Bionda, sun-dried tomatoes, and shaved Grano Padano cheese. Finished with a house-made Caesar dressing and a fragrant drizzle of pesto oil.",
          calories: 520,
          branch: "Al Qana",
        },
        {
    ...
    },
    {
      ...
      items: [
        ...
        findItem("desserts", "d_aseeda")!,
        {
          ...
          image: "https://iili.io/q2ARzyG.jpg",
          ingredients:
            "Caramelized and served with vanilla ice cream, almond streusel, whipped vanilla cream, and rhubarb compote (option salted caramel, mix berries compote on the side)",
          branch: "Al Qana",
        },
      ...
      items: [
{
        ...
        },
        {
          ...
          image: "https://iili.io/qqGfw3x.jpg",
          ingredients:
            "English muffins with cream cheese, tomato sauce, smoky bacon, poached eggs, miso hollandaise",
          branch: "Al Qana",
        },
        {
          id: "egg_avo",
...
const createMarinaMenu = (): MenuCategory[] => {
  ...
  marinaTea.items = marinaTea.items.filter(
    (i: any) => i.id !== "tea_black" && i.id !== "tea_green",
  );
...
const applyGoldenRuleLayout = (menu: MenuCategory[]): MenuCategory[] => {
  ...
  const extract = (
    predicate: (c: MenuCategory) => boolean,
  ...
  if (specialtyItems.length > 0) {
    ...
    const uniqueFilteredItems = Array.from(
      new Map(allFilteredItems.map((item) => [item.id, item])).values(),
    );

    const filteredHotItems: any[] = [];
    const coldDripItems: any[] = [];
    const coldBrewItems: any[] = [];
    ...
    uniqueFilteredItems.forEach((originalItem) => {
      ...
      let isColdBrew =
        item.id.includes("cb_") ||
        item.name.toLowerCase().includes("cold brew");
      let isColdDrip =
        item.id.includes("cd_") ||
      ...
      if (matchedOrigin) {
        if (!origin) origin = matchedOrigin;
        if (!process) {
        ...
        if (parts.length > 1) {
          ...
          if (!process) process = parts.slice(1).join("-").trim();
        } else {
          if (!origin) origin = cleanName;
        }
      }
    ...
    const newSubCategories: MenuCategory[] = [];
  ...
  // 4. SIGNATURES DRINKS
  const sigTeaItems = extractAll((c) =>
    ["signature-drinks", "tea", "juices", "smoothies"].includes(c.id),
  );
  ...
  // 6. BAKE GOODS
  const bakedItems = extractAll((c) =>
    ["baked-goods", "baked-items", "from-our-bakery"].includes(c.id),
  );
    ...
    BASE_MENU.find((c) => c.id === "juices")!,
    {
      ...
      items: [
        findItem("signature-drinks", "sig3")!, // Matcha Cloud
        {
          ...
          ingredients:
            "Matcha cream, matcha dust, coconut water, strawberry infusion",
          calories: 230,
        },
        {
          id: "sig_blue_cloud",
          ...
          image: "https://iili.io/q2ugtIa.png",
          ingredients:
            "Matcha cream, matcha dust, coconut water, blue spirulina",
          calories: 230,
        },
...
export const sortFilteredCoffeeByPrice = (
  directory: BranchMenuDirectory,
): BranchMenuDirectory => {
  ...
  const processCategory = (category: MenuCategory): MenuCategory => {
    // Check if category is related to Filtered Coffee
    const isFiltered =
      category.id === "filter-coffee" ||
  ...
  const sortedDirectory: BranchMenuDirectory = {};
...
(() => {
      ...
      if (cat.items) {
        cat.items.forEach((item) => {
          ...
          if (beanCustomization && beanCustomization.options) {
            beanCustomization.options.forEach((opt: any) => {
  ...
  if (khalMenu) {
    ...
    if (espressoCat) {
      if (espressoCat.beanSelection) {
        espressoCat.beanSelection = espressoCat.beanSelection.filter(
          (b) => !b.name || !b.name.toLowerCase().includes("costa rica")
        );
      ...
      if (espressoCat.items) {
        espressoCat.items.forEach((item) => {
          ...
          if (beanCustomization && beanCustomization.options) {
            beanCustomization.options = beanCustomization.options.filter(
              (o: any) => !o.name || !o.name.toLowerCase().includes("costa rica")
            );
            if (!beanCustomization.options.some((o: any) => o.name?.toLowerCase() === "coconutella")) {
  ...
  const globalDisallowed = (name: string): boolean => {
    const nameLower = name.toLowerCase().trim();
    if (nameLower.includes("tiramisu")) return true;
    if (nameLower.includes("watermelon")) return true;
    if (nameLower.includes("pitaya")) return true;
    if (nameLower.includes("peanut") && nameLower.includes("tart")) return true;
    return false;
  };
...
(() => {
  ...
  Object.keys(RAW_BRANCH_MENUS).forEach(branchId => {
    ...
    branchMenu.forEach(cat => {
      ...
      const isEggCategory = cat.items?.some((i: any) => eggItems.includes(i.name)) || cat.id === 'eggs-more';
      ...
      fixStrings(cat);
      if (cat.items) cat.items.forEach((item: any) => fixStrings(item));
      if (cat.subCategories) {
        cat.subCategories.forEach((sub: any) => {
          fixStrings(sub);
          if (sub.items) sub.items.forEach((item: any) => fixStrings(item));
        });
      }
    ...
    // Reorder
    const getOrderIdx = (title: string) => {
      if (title === 'BEST SELLER') return -1;
  ...
  Object.keys(RAW_BRANCH_MENUS).forEach(branchId => {
    ...
    if (bestSeller) {
      ...
      desiredBestSellers.forEach(itemName => {
        ...
        for (const cat of branchMenu) {
          if (cat === bestSeller) continue; // Skip best seller itself
          
          if (cat.items) {
            const match = cat.items.find((i: any) => i.name.toLowerCase() === itemName.toLowerCase());
          ...
          if (!foundItem && cat.subCategories) {
            for (const sub of cat.subCategories) {
              if (sub.items) {
                const match = sub.items.find((i: any) => i.name.toLowerCase() === itemName.toLowerCase());
                if (match) foundItem = match;
              }
            }
          }
